...
export const FluidParticlesBackground = ({
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Trail fill — slightly transparent black to fade old frames
      ctx.fillStyle = isDark ? "rgba(3,7,18,0.18)" : "rgba(255,255,255,0.12)";
      ...
      for (const p of particles) {
        ...
        p.velocity.x = Math.cos(angle) * 2;
        p.velocity.y = Math.sin(angle) * 2;
        p.x += p.velocity.x;
        p.y += p.velocity.y;
